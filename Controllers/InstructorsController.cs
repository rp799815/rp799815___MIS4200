...
namespace rp799815_MIS4200.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "instructorID,instructorFirstName,instructorIastName,phone,email")] Instructors instructors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "instructorID,instructorFirstName,instructorIastName,phone,email")] Instructors instructors)
        {
            if (ModelState.IsValid)
            {
